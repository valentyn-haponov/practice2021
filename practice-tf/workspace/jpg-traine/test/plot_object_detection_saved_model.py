...
#IMAGE_PATHS = ['img (1).jpg', 'img (2).jpg', 'img (3).jpg', 'img (4).jpg', 'img (5).jpg', 'img (6).jpg', 'img (7).jpg', 'img (8).jpg']
...
PATH_TO_MODEL_DIR = '..\exported-models\model_res'
...
for image_path in IMAGE_PATHS:
    ...
    plt.savefig(image_path + '_result.png')
    print('Done')
plt.show()
